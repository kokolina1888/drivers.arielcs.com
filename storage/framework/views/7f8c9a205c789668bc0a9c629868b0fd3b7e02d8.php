<?php $__env->startSection('title', 'Потребители - добави нов'); ?>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">ДОБАВИ НОВ ПОТРЕБИТЕЛ</h4>                
            </div>
            <div class="card-body collapse in">
                <div class="card-block">                        
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('users_create')); ?>">
