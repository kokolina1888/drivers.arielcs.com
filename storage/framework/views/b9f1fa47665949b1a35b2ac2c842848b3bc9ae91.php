		...
		<div class="card">
			...
			<div class="card-body collapse in">
				<div class="card-block card-dashboard"> 
					<form id="filter-period" method="get" action="<?php echo e(route('reports_international_view')); ?>">
						<div class="row">
						...
						<a href="<?php echo e(route('reports_international_init')); ?>" class="btn btn-info">Задай нов период</a>
					</form>
