<?php $__env->startSection('title', 'Пътен лист - добави нов'); ?>
                           ...
                           <!-- drivers and order end -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select id="t" name="truck" class="form-control">
                                        ...
                                        <option value="<?php echo e($t->id); ?>"><?php echo e($t->number); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="km_s" class="form-control" value="<?php echo e(old('')); ?>" placeholder="Начален километраж ..." name="km_start">   
                                ...
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="km_e" class="form-control" value="<?php echo e(old('')); ?>" placeholder="Краен километраж ..." name="km_e">
