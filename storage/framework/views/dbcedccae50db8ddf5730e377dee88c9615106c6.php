<?php $__env->startSection('title', 'Документи - редакция ръчно въвеждане на данни'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block">                        
                    <form class="form form form-horizontal row-separator" action="<?php echo e(route('update_handentered_data', $route_list->id)); ?>" method="post" enctype="multipart/form-data">
                           ...
                           <!-- drivers and order end -->
                            <div class="row form-group">                                
                                <div class="col-sm-6">                                
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" id="date" class="form-control" value="<?php echo e($route_list->documents[0]->date_created); ?>" placeholder="дата" name="date">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-8">                                
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="document" class="form-control" value="<?php echo e($route_list->documents[0]->document_number); ?>"  placeholder="Товарителница номер ...." name="document">
                                ...
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="total_weight" class="form-control" value="<?php echo e($route_list->documents[0]->total_weight); ?>"  placeholder="Тегло ..." name="total_weight">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12">                                
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="doc_receiver" class="form-control" value="<?php echo e($route_list->documents[0]->receiver); ?>" placeholder="Товарителница получател ..." name="doc_receiver">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12">                                
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="doc_receiver_address" class="form-control" value="<?php echo e($route_list->documents[0]->receiver_address); ?>" placeholder="Получател адрес ..." name="doc_receiver_address">
