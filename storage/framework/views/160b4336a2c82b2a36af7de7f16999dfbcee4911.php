	...
	<div class="col-xs-12">		 
		<div class="card">
			...
			<div class="card-body collapse in">
				...
				<div class="card-block card-dashboard">
					<a href="<?php echo e(route('export_spravka', ['date_range' => $date_range, 'office'=>$office])); ?>" class="btn btn-info">Експортирай справката</a>
					<a href="<?php echo e(route('reports_spravka_init')); ?>" class="btn btn-warning">Назад</a>
				</div>
			</div>
		</div>
	</div>
