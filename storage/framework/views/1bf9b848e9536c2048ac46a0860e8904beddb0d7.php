<?php $__env->startSection('title', 'Справка - Справка'); ?>
	...
	<div class="col-xs-12">		 
		<div class="card">
			<div class="card-header">
				...
				<p><i>Товари, сумарно по дни и по МПС. Включително МПС без товари за месеца. Без товарите международен транспорт.</i></p>

			</div>        
			<div class="card-body collapse in">
				<div class="card-block card-dashboard"> 
					<form id="filter-period" method="get" action="<?php echo e(route('reports_spravka_view')); ?>">
						<div class="row">
						...
						<a href="<?php echo e(route('reports_noname_init')); ?>" class="btn btn-info">Задай нов период</a>
					</form>
...
<script type="text/javascript">
	...
	$('#export-report').on('click', function(e){
		...
		window.location.href = host+'/reports-reference-export?date_range=' + date + '&office='+office;
	});
</script>
