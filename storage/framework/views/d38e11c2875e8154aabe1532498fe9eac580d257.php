<?php $__env->startSection('title', 'Справка - Шофьори, провинциални - курсове в София'); ?>
		...
		<div class="card">
			...
			<div class="card-body collapse in">
				<div class="card-block card-dashboard"> 
					<form id="filter-period" method="get" action="<?php echo e(route('reports_province_drivers_in_sofia_view')); ?>">
						<div class="row">
