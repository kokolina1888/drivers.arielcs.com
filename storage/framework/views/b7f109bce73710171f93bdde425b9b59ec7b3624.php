	...
	<div class="col-xs-12">		 
		<div class="card">
			<div class="card-header">
				...
				<p><i>Справка по офиси - товари в рамките на България по дни</i></p>
			</div>        
			<div class="card-body collapse in">
				<div class="card-block card-dashboard"> 
					<form id="filter-period" method="get" action="<?php echo e(route('reports_drivers_to_days_view')); ?>">
						<div class="row">
						...
						<div class="row">					
							<div class="col-md-6">                            
                        	    <label for="office">Офис <span data-toggle="tooltip" data-placement="top" title="Изберете офис - към момента е коректна за офис София"><i class="fas fa-info-circle"></i></span></label>
						...
						<a href="<?php echo e(route('reports_drivers_to_days_init')); ?>" class="btn btn-info">Задай нов период</a>
					</form>
...
<script type="text/javascript">
	...
	$('#export-report').on('click', function(e){
		...
		window.location.href = host+'/reports-drivers-to-days-export?date_range=' + date + '&office='+office;
	});
</script>
