<?php $__env->startSection('title', 'Ръчно въведени документи - списък'); ?>
			...
			<div class="card-body collapse in">
				<div class="card-block card-dashboard">
					<div class="table-responsive">
						<table class="table">							
							<form id="filter-form" method="get" action="<?php echo e(route('data_hand_list', ['id', 'DESC'])); ?>">
								...
								<thead>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo e(route('data_hand_list', ['order'=>'id', 'direction' => 'DESC'])); ?>" class="btn btn-warning">Изчисти</a>
										</td>
									</tr>
								</thead>
							</form>
