<?php $__env->startSection('title', 'Файл - добави нов'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block">                        
                    <form class="form form-horizontal row-separator" method="post" enctype="multipart/form-data" action="<?php echo e(route('bulk_save_sales_data')); ?>">
                        <?php echo e(csrf_field()); ?>

                        <div class="form-body">
                            <p><i>Качения файл ще намерите <a href="<?php echo e(route('sales_data_file_list', ['id', 'DESC'])); ?>">тук</a></i> Сортирайте по No на документ, преди запис на файла!</p>
                            <div class="row">
