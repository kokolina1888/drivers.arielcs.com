...
@section('title', 'Справка - Международен транспорт')
		...
		<div class="card">
			...
			<div class="card-body collapse in">
				<div class="card-block card-dashboard"> 
					<form id="filter-period" method="get" action="{{ route('reports_international_view') }}">
						<div class="row">
						...
						<a href="{{ route('reports_international_init') }}" class="btn btn-info">Задай нов период</a>
					</form>
...
<script type="text/javascript">
	...
	$('#export-report').on('click', function(e){
		...
		window.location.href = host+'/reports-international-export?date_range=' + date + '&office='+office;
	});
</script>
@endsection