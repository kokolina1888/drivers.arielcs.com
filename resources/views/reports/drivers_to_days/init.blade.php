		...
		<div class="card">
			...
			<div class="card-body collapse in">
				<div class="card-block card-dashboard"> 
					<form id="filter-period" method="get" action="{{ route('reports_drivers_to_days_view') }}">
						<div class="row">
						...
						<a href="{{ route('reports_drivers_to_days_init') }}" class="btn btn-info">Задай нов период</a>
					</form>
