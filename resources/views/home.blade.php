    ...
    <div class="card">
      <div class="card-body">
        <div class="card-block">
          <div class="media">
            <a href="{{ route('route_lists_list', ['id', 'DESC']) }}">
  ...
  <div class="col-xl-3 col-lg-6 col-xs-12">
    <div class="card">
      <div class="card-body">
        <div class="card-block">
          <div class="media">
             <a href="{{ route('documents_list', ['id', 'DESC']) }}">
              <div class="media-body text-xs-left">             
  ...
  <div class="col-xl-3 col-lg-6 col-xs-12">
    <div class="card">
      <div class="card-body">
        <div class="card-block">
          <div class="media">
            <a href="{{ route('create_data_by_hand') }}">
              <div class="media-body text-xs-left">
...
<div class="row match-height">
  <div class="col-xl-4 col-xs-12">
    <div class="card">
      <a href="{{ route('reports_original_init') }}">
        <div class="card-body">
          <div class="media">
    ...
    <div class="card">
      <a href="{{ route('reports_international_init') }}">
        <div class="card-body">
          <div class="media">
    ...
    <div class="card">
      <a href="{{ route('reports_noname_init') }}">
      <div class="card-body">
        <div class="media">          
    ...
    <div class="card">
      <a href="{{ route('reports_spravka_init') }}">      
        <div class="card-body">
          <div class="media">
  ...
  <div class="col-xl-4 col-xs-12">    
    <div class="card">
      <a href="{{ route('reports_drivers_to_days_init') }}">      
        <div class="card-body">
          <div class="media">
    ...
    <div class="card">
      <a href="{{ route('reports_drivers_for_period_init') }}">      
        <div class="card-body">
          <div class="media">
    ...
    <div class="card">
      <a href="{{ route('reports_province_drivers_in_sofia_init') }}">      
        <div class="card-body">
          <div class="media">
