...
@section('title', 'Пътен лист - редактиране')
                                ...
                                <div class="doc-list-container col-sm-4">
                                    <table class="table table-striped">
                                        ...
                                        @if( $documents->count() > 0)
                                            ...
                                            <tr>
                                                <td class="document-row-num">{{ $row_num++ }}</td>        
                                                <td class="document-info" data-document="{{ $d->id }}">
                                                    {{ $d->document_number }} - {{ $d->total_weight}} кг.
                                                </td>
...
$('#submit-form').on('click', function(e){
    ...
    var routeListId = '{{ $route_list->id}}',
        ...
        filter_first_driver = '{{ $filter_first_driver }}', 
        filter_second_driver = '{{ $filter_second_driver }}', 
