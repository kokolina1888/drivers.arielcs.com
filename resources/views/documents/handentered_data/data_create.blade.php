...
@section('title', 'Документи - ръчно въвеждане на данни')
        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block">                        
                    <form class="form form form-horizontal row-separator" action="{{ route('store_handentered_data') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group row">              
                                <div class="col-sm-4">                  
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="on" class="form-control" value="{{ old('order_number') }}" placeholder="Заповед No ..." name="order_number">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <select id="d1" name="driver1" class="form-control">
                                        ...
                                        <option value="{{ $d->id }}" <?php if(old('driver1') == $d->id) { echo "selected"; } ?>>{{ $d->name }}</option>
                                        @endforeach                                                
                                    </select>
                            ...
                            <!-- driver 2 data -->
                             <div class="form-group row">              
                                <div class="col-sm-4">                  
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="on2" class="form-control" value="{{ old('order_number2') }}" placeholder="Заповед No ..." name="order_number2">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="col-sm-12">
                                        <select id="d2" name="driver2" class="form-control">
                                            <option value="">-- изберете --</option>
                                            @foreach( $drivers as $d)
                                            <option value="{{ $d->id }}" <?php if(old('driver2') == $d->id) { echo "selected"; } ?>>{{ $d->name }}</option>
                                            @endforeach                                                
                                        </select>
                           ...
                           <!-- drivers and order end -->
                            <div class="row form-group">                                
                                <div class="col-sm-6">                                
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" id="date" class="form-control" value="{{ old('date') }}" placeholder="дата" name="date">
                                        @if($errors->has('date'))
                                        <div class="col-sm-7 col-sm-offset-1 text-danger">
                                            {{ $errors->first('date') }} 
                                        </div>
                                ...
                                <div class="col-sm-6">                                
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="rl" class="form-control" value="{{ old('route_list') }}" placeholder="Пътен лист ..." name="route_list">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-8">                                
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="document" class="form-control" value="{{ old('document') }}"  placeholder="Товарителница номер ...." name="document">
                                ...
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="total_weight" class="form-control" value="{{ old('total_weight') }}"  placeholder="Тегло ..." name="total_weight">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select id="t" name="truck" class="form-control">
                                        <option value="">-- изберете --</option>
                                        @foreach( $trucks as $t)
                                        <option value="{{ $t->id }}" <?php if(old('truck') == $t->id) { echo "selected"; } ?>>{{ $t->number }}</option>
                                        @endforeach                                                
                                    </select>
                                    @if($errors->has('truck'))
                                        <div class="col-sm-7 col-sm-offset-1 text-danger">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="km_s" class="form-control" value="{{ old('km_start') }}" placeholder="Начален километраж ..." name="km_start">   
                                ...
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="km_e" class="form-control" value="{{ old('km_end') }}" placeholder="Краен километраж ..." name="km_end">
                                ...
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="km_r" class="form-control" value="{{ old('km_run') }}" placeholder="Изминати километри ..." name="km_run">
                            ...
                            <div class="form-group row">  
                                <div class="col-sm-4">                                
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="gas_q" class="form-control" value="{{ old('gas_quant') }}" placeholder="Заредено гориво ..." name="gas_quant">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12">                                
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="doc_receiver" class="form-control" value="{{ old('doc_receiver') }}" placeholder="Товарителница получател ..." name="doc_receiver">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12">                                
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="doc_receiver_address" class="form-control" value="{{ old('doc_receiver_address') }}" placeholder="Получател адрес ..." name="doc_receiver_address">
