...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
  ...
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      <li class="nav-item active"><a <?php if(Route::currentRouteName() === 'home'){ echo 'class=open-active-list'; }?> href="{{ route('home') }}"><i class="fas fa-home"></i> Начало</a>         
      </li>
      <li class="nav-item <?php if(Route::currentRouteName() === 'drivers_list' || Route::currentRouteName() === 'drivers_create' || Route::currentRouteName() === 'drivers_edit' || Route::currentRouteName() === 'offices_list' || Route::currentRouteName() === 'offices_create' || Route::currentRouteName() === 'offices_edit'){ echo 'open-active open'; }?>"><a href="#"><i class="fas fa-male"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Водачи</span></a>
        <ul class="menu-content">
          <li><a <?php if(Route::currentRouteName() === 'drivers_list' || Route::currentRouteName() === 'drivers_edit'){ echo 'class=open-active-list'; }?> href="{{ route('drivers_list') }}" class="menu-item"><i class="fas fa-user-tie"></i> Списък водачи</a>
          </li>
          ...
          @endif
          <li><a <?php if(Route::currentRouteName() === 'offices_list' || Route::currentRouteName() === 'offices_edit'){ echo 'class=open-active-list'; }?> href="{{ route('offices_list') }}" class="menu-item"> <i class="fas fa-igloo"></i> Списък офиси</a>
          </li>
          @if( Auth::user()->role == 'admin')
          <li><a <?php if(Route::currentRouteName() === 'offices_create'){ echo 'class=open-active-list'; }?> href="{{ route('offices_create') }}" data-i18n="nav.page_layouts.2_columns" class="menu-item">Добави офис</a>
          @endif
          </li>            
        </ul>
      </li>
      <li class="nav-item <?php if(Route::currentRouteName() === 'trucks_list' || Route::currentRouteName() === 'trucks_create' || Route::currentRouteName() === 'trucks_edit' || Route::currentRouteName() === 'trucks_weight_categories_list' || Route::currentRouteName() === 'trucks_weight_category_create' || Route::currentRouteName() === 'trucks_weight_category_edit'){ echo 'open-active open'; }?>"><a href="#"><i class="fas fa-truck"></i><span data-i18n="nav.project.main" class="menu-title">МПС</span></a>
        <ul class="menu-content">
          ...
          @endif
          <li><a <?php if(Route::currentRouteName() === 'trucks_weight_categories_list' || Route::currentRouteName() === 'trucks_weight_category_edit'){ echo 'class=open-active-list'; }?> href="{{ route('trucks_weight_categories_list') }}" data-i18n="nav.gallery_pages.gallery_grid" class="menu-item">Списък - Тонажни категории</a>
          </li>
          @if( Auth::user()->role == 'admin')
          <li><a <?php if(Route::currentRouteName() === 'trucks_weight_category_create'){ echo 'class=open-active-list'; }?> href="{{ route('trucks_weight_category_create') }}" data-i18n="nav.gallery_pages.gallery_grid" class="menu-item">Добави тонажна категория</a>
          </li>
          @endif
        </ul>
      </li>
      <li class="nav-item <?php if(Route::currentRouteName() === 'documents_list' || Route::currentRouteName() === 'route_list_create' || Route::currentRouteName() === 'documents_edit' || Route::currentRouteName() === 'create_data_by_hand' || Route::currentRouteName() === 'edit_handentered_data' || Route::currentRouteName() === 'route_lists_list' || Route::currentRouteName() === 'bulk_add_sales_data' || Route::currentRouteName() === 'sales_data_file_list' || Route::currentRouteName()=='route_list_edit' || Route::currentRouteName() === 'data_hand_list' || Route::currentRouteName() === 'edit_handentered_data' || Route::currentRouteName() === 'update_handentered_data'){ echo 'open-active open'; }?>"><a href="#"><i class="fas fa-file"></i><span data-i18n="nav.cards.main" class="menu-title">Документи</span></a>
        <ul class="menu-content">
        	<li><a href="{{ route('documents_list', ['id', 'DESC']) }}"  <?php if(Route::currentRouteName() === 'documents_list' || Route::currentRouteName() === 'documents_edit' || Route::currentRouteName() === 'documents_list'){ echo 'class=open-active-list'; }?> class="menu-item"><i class="fas fa-clipboard-list"></i> Списък товарителници</a>
          </li>
          <li><a href="{{ route('route_lists_list', ['id', 'DESC']) }}"  <?php if(Route::currentRouteName() === 'route_lists_list' || Route::currentRouteName()=='route_list_edit'){ echo 'class=open-active-list'; }?> class="menu-item"><i class="fas fa-list-ul"></i> Списък пътни листове</a>
          </li>          
          <li><a href="{{ route('data_hand_list', ['id', 'DESC']) }}"  <?php if(Route::currentRouteName() === 'data_hand_list' || Route::currentRouteName() === 'edit_handentered_data' || Route::currentRouteName() === 'update_handentered_data'){ echo 'class=open-active-list'; }?> class="menu-item"><i class="fas fa-list-ol"></i> Списък ръчно въведени документи</a>
          </li>
          <li><a href="{{ route('route_list_create') }}" <?php if(Route::currentRouteName() === 'route_list_create'){ echo 'class=open-active-list'; }?> class="menu-item"><i class="fas fa-boxes"></i> Добавяне пътен лист <br> с товарителници</a>
          </li>          
          ...
          <li>
            <a href="{{ route('bulk_add_sales_data') }}"  <?php if(Route::currentRouteName() === 'bulk_add_sales_data'){ echo 'class=open-active-list'; }?> class="menu-item">
              <i class="fa fa-upload" aria-hidden="true"></i>
              Добавяне справка продажби <br> с 2ра м. ед.
            </a>
          </li>           
          <li><a href="{{ route('sales_data_file_list', ['id', 'DESC']) }}" <?php if(Route::currentRouteName() === 'sales_data_file_list'){ echo 'class=open-active-list'; }?> class="menu-item">
    ...
    <li class="nav-item <?php if(Route::currentRouteName() === 'reports_original_init' || Route::currentRouteName() === 'reports_original_view' || Route::currentRouteName() === 'reports_spravka_init' || Route::currentRouteName() === 'reports_spravka_view' || Route::currentRouteName() === 'reports_international_init' || Route::currentRouteName() === 'reports_international_view' || Route::currentRouteName() === 'reports_noname_init' || Route::currentRouteName() === 'reports_noname_view' || Route::currentRouteName() === 'reports_drivers_to_days_init' || Route::currentRouteName() === 'reports_drivers_to_days_view' || Route::currentRouteName() === 'reports_drivers_for_period_init' || Route::currentRouteName() === 'reports_drivers_for_period_view' || Route::currentRouteName() === 'reports_province_drivers_in_sofia_init' || Route::currentRouteName() === 'reports_province_drivers_in_sofia_view'){ echo 'open-active open'; }?>"><a href="#"><i class="fas fa-file"></i><span data-i18n="nav.cards.main" class="menu-title">Справки</span></a>
      <ul class="menu-content">
        <li class="<?php if(Route::currentRouteName() === 'reports_original_init' || Route::currentRouteName() === 'reports_original_view'){ echo 'active'; }?>"><a href="{{ route('reports_original_init') }}" <?php if(Route::currentRouteName() === 'reports_original_init' || Route::currentRouteName() === 'reports_original_view' ){ echo 'class=open-active-list'; }?> class="menu-item"><i class="fas fa-barcode"></i> Справка "Оригинал"</a>
        </li>
        <li class="<?php if(Route::currentRouteName() === 'reports_international_init' || Route::currentRouteName() === 'reports_international_view'){ echo 'active'; }?>"><a href="{{ route('reports_international_init') }}" <?php if(Route::currentRouteName() === 'reports_international_init' || Route::currentRouteName() === 'reports_international_view'){ echo 'class=open-active-list'; }?> class="menu-item"><i class="fas fa-drafting-compass"></i> Справка "Международен транспорт"</a>
        </li>
        <li class="<?php if(Route::currentRouteName() === 'reports_noname_init' || Route::currentRouteName() === 'reports_noname_view'){ echo 'active'; }?>">
          <a href="{{ route('reports_noname_init') }}" class="menu-item <?php if(Route::currentRouteName() === 'reports_noname_init' || Route::currentRouteName() === 'reports_noname_view'){ echo 'open-active-list'; }?>"><i class="fas fa-bezier-curve"></i> Справка "Без име"</a>
        </li>
        <li class="<?php if(Route::currentRouteName() === 'reports_spravka_init' || Route::currentRouteName() === 'reports_spravka_view'){ echo 'active'; }?>">
          <a href="{{ route('reports_spravka_init') }}" class="menu-item <?php if(Route::currentRouteName() === 'reports_spravka_init' || Route::currentRouteName() === 'reports_spravka_view'){ echo 'open-active-list'; }?>"><i class="fas fa-chess-knight"></i> Справка "Справка"</a>
        </li>
        <li class="<?php if(Route::currentRouteName() === 'reports_drivers_to_days_init' || Route::currentRouteName() === 'reports_drivers_to_days_view'){ echo 'active'; }?>">
          <a href="{{ route('reports_drivers_to_days_init') }}" class="menu-item <?php if(Route::currentRouteName() === 'reports_drivers_to_days_init' || Route::currentRouteName() === 'reports_drivers_to_days_view'){ echo 'open-active-list'; }?>"><i class="fas fa-code-branch"></i> Шофьори - по дни</a>
        </li>
        <li class="<?php if(Route::currentRouteName() === 'reports_drivers_for_period_init' || Route::currentRouteName() === 'reports_drivers_for_period_view'){ echo 'active'; }?>">
          <a href="{{ route('reports_drivers_for_period_init') }}" class="menu-item <?php if(Route::currentRouteName() === 'reports_drivers_for_period_init' || Route::currentRouteName() === 'reports_drivers_for_period_view'){ echo 'open-active-list'; }?>"><i class="fas fa-chess"></i> Шофьори - сумарна</a>
        </li>
        <li class="<?php if(Route::currentRouteName() === 'reports_province_drivers_in_sofia_init' || Route::currentRouteName() === 'reports_province_drivers_in_sofia_init'){ echo 'active'; }?>">
          <a href="{{ route('reports_province_drivers_in_sofia_init') }}" class="menu-item <?php if(Route::currentRouteName() === 'reports_province_drivers_in_sofia_init' || Route::currentRouteName() === 'reports_province_drivers_in_sofia_view'){ echo 'open-active-list'; }?>"><i class="fas fa-dice-d20"></i> Шофьори - провинциални</a>
        </li>
      </ul>
    </li>      
    @if( Auth::user()->role == 'admin')
